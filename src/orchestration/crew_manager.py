...
class StudentLearningCrew:
    ...
    def process_question(self, question):
        ...
        # Create tasks
        task1 = build_expert_task(self.tutor, "Provide a clear, foundational explanation", context, question)
        task2 = build_expert_task(self.coach, "Explain with analogies and encouragement", context, question)
        task3 = build_expert_task(self.analyst, "Provide deeper insights and analysis", context, question)
        ...
        synth_crew = Crew(agents=[self.synthesizer.agent], tasks=[synth_task], verbose=False)
